...
export type FakeProduct = {
  ...
  available?: boolean;
  companyId?: string;
  /** Catalog attributes returned by product details, e.g. { "Склад": "..." }. */
...
const catalog: Record<string, FakeProduct[]> = {
  ...
  "печиво": [
    ...
    { id: "p-plain-cookie", externalProductId: 802, slug: "pechyvo-vershkove", name: "Печиво вершкове", price: 49, attributes: { "Склад": "борошно пшеничне, цукор, масло вершкове" } },
    { id: "p-mystery-cookie", externalProductId: 803, slug: "pechyvo-maria", name: "Печиво Марія", price: 39 },
  ],
  "крекер": [
    { id: "p-cracker", externalProductId: 804, slug: "kreker", name: "Крекер солоний", price: 35 },
  ],
  "паста горіхова": [
    { id: "p-nut-paste", externalProductId: 805, slug: "pasta-gorikhova", name: "Паста горіхова з какао", price: 120, attributes: { "Склад": "цукор, горіхи фундук, какао" } },
  ],
  "гель для душу": [
